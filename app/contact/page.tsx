        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="p-6 lg:p-8 rounded-xl border border-gray-100 bg-white">
            ...
            <div className="space-y-6">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-500">info@sl-trade.com</div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-lg bg-primary-light/10 flex items-center justify-center shrink-0">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-500">+86 138 0000 0000</div>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
              ...
              <div className="p-6 rounded-xl bg-surface border border-gray-100">
                ...
                <div className="space-y-2 text-sm text-gray-500">
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-900 font-medium">9:00 - 18:00 (CST)</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Saturday</span>
                    <span className="text-gray-900 font-medium">10:00 - 16:00 (CST)</span>
                  </div>
                  <div className="flex justify-between">
