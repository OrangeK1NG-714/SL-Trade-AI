...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-surface">
      ...
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-60 bg-primary-dark flex flex-col transform transition-transform duration-200 ease-in-out ${
      ...
      >
        <div className="flex items-center gap-2 px-5 py-5 border-b border-white/10">
          ...
          <span className="text-white font-bold text-lg">SL Trade AI</span>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="sticky top-0 z-30 bg-white border-b border-gray-100 px-4 py-3 flex items-center gap-4 lg:px-6">
          <button
