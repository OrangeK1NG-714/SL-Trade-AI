...
const regions = [
  { name: "West Africa", countries: "Nigeria, Ghana, Senegal, Cameroon" },
  { name: "East Africa", countries: "Kenya, Tanzania, Ethiopia, Uganda" },
  { name: "Southern Africa", countries: "South Africa, Mozambique, Zambia" },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-3 text-gray-500 max-w-lg mx-auto">
              We deliver to major ports across Africa, with established
              logistics networks in key markets.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {regions.map((region) => (
              <div
                key={region.name}
                className="p-6 rounded-xl bg-surface border border-gray-100"
              >
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
                  {region.name}
                </h3>
                <p className="text-sm text-gray-500">{region.countries}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-r from-primary to-primary-light">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 text-lg text-white/70 max-w-2xl mx-auto">
            Get competitive quotes for plastic raw materials delivered to your
            door. Our team responds within 24 hours.
          </p>
